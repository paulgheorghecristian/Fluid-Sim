...
Mesh* Mesh::get_rectangle_mesh(float x, float y, float width, float height) {
    ...
    vertices.push_back(Vertex(glm::vec3(x, y, 0.0f), glm::vec3 (0), glm::vec2 (0,1)));
    vertices.push_back(Vertex(glm::vec3(x+width, y, 0.0f), glm::vec3 (0), glm::vec2 (1,1)));
    vertices.push_back(Vertex(glm::vec3(x+width, y+height, 0.0f), glm::vec3 (0), glm::vec2 (1,0)));
    vertices.push_back(Vertex(glm::vec3(x, y+height, 0.0f), glm::vec3 (0), glm::vec2 (0,0)));
